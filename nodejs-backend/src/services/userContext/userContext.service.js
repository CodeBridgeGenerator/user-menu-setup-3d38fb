const { UserContext } = require("./userContext.class");
const createModel = require("../../models/userContext.model");
const hooks = require("./userContext.hooks");
...
module.exports = function (app) {
  ...
  app.use("/userContext", new UserContext(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("userContext");

  // Get the schema of the collections 
  app.get("/userContextSchema", function (request, response) {
