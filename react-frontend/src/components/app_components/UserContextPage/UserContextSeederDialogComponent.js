...
import seederData from "./userContext.seeder.json";
...
const UserContextSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UserContextSeederDialogComponent);
